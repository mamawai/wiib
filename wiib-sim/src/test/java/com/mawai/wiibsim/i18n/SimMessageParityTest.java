package com.mawai.wiibsim.i18n;
...
class SimMessageParityTest {
    ...
    /** sim 的域文件都装上了：漏放一个 messages 目录，上面两条会因为"没这些 key"而假绿 */
    @Test
    void sim自己的域文件确实装上了() {
