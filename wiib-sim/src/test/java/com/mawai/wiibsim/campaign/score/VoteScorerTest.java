 ...
 * 投票奖池分配。
 * <p>
 * 【共享池带来反向赔率】扎堆投 BTC 时猜对的人多、每人分少；冷门那边猜对反而分多。
 * 这是设计要的效果，测试要钉住"每票价值 = 池 ÷ 当日总正确票数"这个式子本身。
 * <p>
 * 【封顶是必需的】均分制下参与人数越少单人拿得越多，活动初期人没聚起来时
 * 早期玩家会拿到远超设计预期的分数。封顶后两周投票最多贡献 84 分，与交易任务同量级。
 */
