...
public class CampaignTask {
     ...
     * 推导见 CampaignVoteService.poolOf）。从昨天往回扫满 15 天，正好覆盖整场 ——
     * 哪怕整场的定时任务全没跑成，跑通一次也能把所有日子补齐，不用人肉介入。
     * <p>
     * 【那"一次"是活动结束后的第二个 UTC 0 点，不是第一个】票投的是明天，
     * 最后一个投票日 08-17 要到 UTC 08-18 才算过完 —— 而 08-18 那次回扫覆盖 08-03 ~ 08-17，
     * 与整场投票日一天不差地对齐。改活动天数的话这个数要跟着改：
     * SWEEP_DAYS 小了尾巴补不全，大了只是多几次空查。
     * <p>
