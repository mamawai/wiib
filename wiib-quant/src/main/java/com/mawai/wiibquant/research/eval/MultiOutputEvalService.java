...
import com.mawai.wiibquant.research.benchmark.BenchmarkCalculator;
import com.mawai.wiibquant.research.forecast.MarketRegime;
import com.mawai.wiibquant.research.forecast.IndicatorAdapter;
import com.mawai.wiibquant.research.forecast.MultiOutputForecast;
import com.mawai.wiibquant.research.forecast.MultiOutputForecaster;
import com.mawai.wiibquant.research.forecast.VolatilityRiskContext;
import com.mawai.wiibquant.research.forecast.VolatilityRiskSummary;
import com.mawai.wiibcommon.market.KlineBar;
import com.mawai.wiibquant.research.label.RegimeLabeler;
import com.mawai.wiibquant.research.metrics.RegimeClassificationScore;
...
public final class MultiOutputEvalService {
    ...
    static MultiOutputReport evaluateBars(String symbol, ForecastHorizon horizon, List<KlineBar> oneMin,
        ...
        double[] prevEwmaSigmaByPoint = new double[points];    // 基准2 装配期 EWMA σ 的 lag-1：仅当被评模型也是 EWMA 时才等价"model 的 lag-1"，对 HAR 等其他腿是独立基准
