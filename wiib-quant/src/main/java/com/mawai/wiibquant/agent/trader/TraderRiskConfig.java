...
public record TraderRiskConfig(int leverageMin, int leverageMax,
    ...
    static final int DEF_LEV_MIN = 3;
    static final int DEF_LEV_MAX = 20;
    static final BigDecimal DEF_MARGIN_MIN = new BigDecimal("5");
    static final BigDecimal DEF_MARGIN_MAX = new BigDecimal("20");
