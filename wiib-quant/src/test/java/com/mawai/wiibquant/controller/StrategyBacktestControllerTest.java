...
class StrategyBacktestControllerTest {
    ...
    void usesLatestLocalCloseTimeAsBacktestEnd() {
        ...
        StrategyBacktestController controller = new StrategyBacktestController(
                store, new com.mawai.wiibquant.strategy.backtest.task.BacktestOrchestrator(store),
                new MessageCatalog());
    ...
    void failsWhenLocalKlineHasNoLatestCloseTime() {
        ...
        StrategyBacktestController controller = new StrategyBacktestController(
                emptyStore, new com.mawai.wiibquant.strategy.backtest.task.BacktestOrchestrator(emptyStore),
                new MessageCatalog());
