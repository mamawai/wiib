...
class TraderWakeupRunnerSleepNoticeTest {
    ...
    void lastBoundaryGetsNotice() {
        String s = TraderWakeupRunner.sleepNotice(WakeWindow.parse("21:00-08:00"), bj(8, 0), H1, bj(8, 0));
    ...
    void manualWakeAfterBoundaryCountsHoursFromNow() {
        String s = TraderWakeupRunner.sleepNotice(WakeWindow.parse("21:00-08:00"), bj(8, 0), H1, bj(8, 20));
    ...
    void notLastOrAllDayIsEmpty() {
        assertThat(TraderWakeupRunner.sleepNotice(WakeWindow.parse("21:00-08:00"), bj(7, 0), H1, bj(7, 0))).isEmpty();
        assertThat(TraderWakeupRunner.sleepNotice(null, bj(8, 0), H1, bj(8, 0))).isEmpty();
    }
}
